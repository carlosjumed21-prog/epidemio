...
def aplicar_formato_oficial(writer, sheet_name, df, servicio_nombre):
    ...
    cell_nom = ws.cell(row=lr + 1, column=1, value="Comentario: de acuerdo con la Norma Oficial Mexicana NOM-045-SSA2-2005... NINGUN RECIPIENTE QUE CONTENGA EL INSUMO DEBERÁ SER RELLENADO O REUTILIZADO.")
